...
| Staff-friendly launcher | `START-HERE.bat`; `backup-database.bat`; `create-desktop-shortcut.bat`; `scripts/create-desktop-shortcut.ps1`; `README-FIRST-WINDOWS.txt`; `docs/OFFLINE_INSTALL_CHECKLIST.md`; `tests/oneClickSetup.test.js`; `npm run verify:bundle` | Implemented and tested |
